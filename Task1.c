...
******************************************************************************
* @file : main.c
* @brief : Task 1 - STM32F4 Mandelbrot Port
******************************************************************************
*/
...
volatile int test_mode = 1; // Use double precision for baseline
/* USER CODE END PV */
...
int main(void)
{
    ...
    for (int j = 0; j < 5; j++) {
        ...
        // Call the Mandelbrot Function and store the output in the checksum variable
        if (test_mode == 0) {
